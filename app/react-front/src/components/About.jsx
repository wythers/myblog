    ...
    <animated.div className="relative flex flex-col px-[10%] w-full gap-[20px]" style={{ ...spring }}>
      <Green />
      {
        lang == 'en' ?
          ...
          <Typography variant="h3" color="gray" className="!font-[400] text-[40px] leading-relaxed lg:w-[80%] 2xl:w-[40%] z-10">
      ...
      }
      {
        lang == 'en' ?
          ...
          <Typography variant="h4" className="!font-[400] text-[28px] leading-[2] lg:w-[700px] z-10 text-gray-700 dark:text-gray-200">
            {about}
          </Typography>
      }
    </animated.div>
